...
VS <- subset(VS_clean, !is.na(Long) & !is.na(Lat))
dim(VS)
...
points(VE$Long, VE$Lat, col='blue', pch=20, cex=0.75)

points(VS$Long, VS$Lat, col='red', cex=0.75)
...
points(VE$Long, VE$Lat, col='blue', cex=0.75)
